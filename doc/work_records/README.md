...
1. 先看 [秋招简历素材库](../秋招简历素材库_AIInfra_2026.md)，按岗位选择 bullet。
2. 再看 [AI Infra 工作总结](../秋招工作总结_AIInfra_2026.md)，理解完整时间线和结论边界。
3. 面试前按目标岗位进入 R3、GEMM、DeepGEMM 或 ICS6201 专题。
4. 需要追溯阶段过程时再读周报，不把周报中的早期口径当最终结论。
...
| C | 短程 smoke 或单次验证 | 32 卡 R3 5-step、fused guard 首次通过 |
