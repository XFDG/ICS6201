...
1. 先看 [8 月 12 日至 9 月 11 日增量工作记录](./2026_q3/2026-08-12_2026-09-11_训练推理算子与系统增量工作记录.md)，了解 FA3 确定性反向、MoE Router、推理自动选核与 B200 验证的新进展。
2. 再看 [2026 年第三季度公开工作记录](./2026_q3/README.md)，了解此前的 MoE、推理优化、KernelBench 和平台验证工作。
3. 再看 [2026-06-15 至 07-15 月报](./monthly_report/2026-06-15_2026-07-15.md)，了解前序工作。
...
| 优先级 | 专题 | 可展示能力 | 入口 |
|---|---|---|---|
| P0 | 8.12-9.11 增量记录 | FA3 deterministic backward、Router orth-loss、推理自动选核、B200 验证 | [2026_q3 增量记录](./2026_q3/2026-08-12_2026-09-11_训练推理算子与系统增量工作记录.md) |
